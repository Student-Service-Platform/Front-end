...
<template>
   ...
   <div style="position:absolute; left:400px; top:70px;">
     ...
     <!-- 第四行：内容 -->
     <div style="display: flex;">
       <cus-box :input="false" content="内容" h="236px" w="141px" :textAlign="['center', 'top']"></cus-box>
       <cus-box :input="false" content="显示内容" h="236px" w="704px" :textAlign="['left', 'top']"></cus-box>
     </div>
  
     <!-- 第五行：照片 -->
     <div style="display: flex;">
       <cus-box :input="false" content="照片" h="274px" w="141px" :textAlign="['center', 'top']"></cus-box>
       <cus-box :input="false" content="显示图片缩略图" h="274px" w="704px" :textAlign="['left', 'top']"></cus-box>
     </div>
   </div>
